...
public class Empleado extends Persona {
    ...
    public DefaultTableModel leer(){
        ...
        try {
            ...
            cn.abrir_cn();
            String query="";
            query = "SELECT e.id_empleados as id ,e.codigo ,e.nombres ,e.apellidos ,e.direccion ,e.telefono ,e.fecha_nacimiento ,concat(p.id_puestos,') ',p.puesto) as puesto FROM  empleados as e inner join puestos as p on e.id_puestos = p.id_puestos;";
